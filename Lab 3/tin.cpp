...
void selection_sort_compare(int*& arr, int n, int& compare)
{
...
void insert_sort_compare(int*& arr, int n, int& compare)
{
...
void shell_sort_compare(int*& a, int n, int& compare)
{
	int interval, i, j, temp;
